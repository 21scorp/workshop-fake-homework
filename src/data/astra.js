...
export const ASTRA = [
...

  {
    ...
    stats: { power: 10, fireRate: 3.2, projectiles: 1, spread: 0, speed: 1.0, hp: 3, crit: 0.05, critDmg: 1.6, magnet: 1.0 },
  ...
  },
  {
    ...
    stats: { power: 8, fireRate: 4.2, projectiles: 1, spread: 0.05, speed: 1.05, hp: 3, crit: 0.06, critDmg: 1.6, magnet: 1.0 },
  ...
  },
  {
    ...
    stats: { power: 14, fireRate: 2.0, projectiles: 1, spread: 0, speed: 0.9, hp: 4, crit: 0.04, critDmg: 1.8, magnet: 0.9 },
  ...
  },
  {
    ...
    stats: { power: 7, fireRate: 5.0, projectiles: 1, spread: 0.08, speed: 1.2, hp: 3, crit: 0.08, critDmg: 1.5, magnet: 1.15 },
  ...
  },
  {
    ...
    stats: { power: 9, fireRate: 3.0, projectiles: 2, spread: 0.16, speed: 1.0, hp: 3, crit: 0.05, critDmg: 1.6, magnet: 1.05 },
...

  {
    ...
    stats: { power: 11, fireRate: 3.4, projectiles: 3, spread: 0.22, speed: 1.0, hp: 3, crit: 0.1, critDmg: 1.7, magnet: 1.0 },
  ...
  },
  {
    ...
    stats: { power: 13, fireRate: 2.4, projectiles: 1, spread: 0, speed: 1.05, hp: 3, crit: 0.07, critDmg: 1.7, magnet: 1.1 },
  ...
  },
  {
    ...
    stats: { power: 6, fireRate: 8.0, projectiles: 2, spread: 0.1, speed: 1.25, hp: 2, crit: 0.14, critDmg: 1.6, magnet: 1.2 },
  ...
  },
  {
    ...
    stats: { power: 26, fireRate: 1.1, projectiles: 1, spread: 0, speed: 0.82, hp: 5, crit: 0.05, critDmg: 2.0, magnet: 0.9 },
  ...
  },
  {
    ...
    stats: { power: 15, fireRate: 2.6, projectiles: 1, spread: 0, speed: 1.02, hp: 3, crit: 0.12, critDmg: 1.9, magnet: 1.3 },
  ...
  },
  {
    ...
    stats: { power: 9, fireRate: 3.6, projectiles: 1, spread: 0, speed: 1.05, hp: 3, crit: 0.15, critDmg: 1.8, magnet: 1.25 },
...

  {
    ...
    stats: { power: 7, fireRate: 12.0, projectiles: 1, spread: 0.34, speed: 1.08, hp: 3, crit: 0.1, critDmg: 1.7, magnet: 1.1 },
  ...
  },
  {
    ...
    stats: { power: 16, fireRate: 1.6, projectiles: 4, spread: 0, speed: 0.98, hp: 4, crit: 0.08, critDmg: 1.8, magnet: 1.15 },
  ...
  },
  {
    ...
    stats: { power: 19, fireRate: 2.8, projectiles: 2, spread: 0.12, speed: 1.18, hp: 3, crit: 0.16, critDmg: 1.85, magnet: 1.2 },
  ...
  },
  {
    ...
    stats: { power: 34, fireRate: 0.9, projectiles: 1, spread: 0, speed: 0.88, hp: 5, crit: 0.06, critDmg: 2.3, magnet: 0.95 },
  ...
  },
  {
    ...
    stats: { power: 14, fireRate: 4.4, projectiles: 3, spread: 0.5, speed: 1.1, hp: 3, crit: 0.2, critDmg: 2.0, magnet: 1.4 },
...

  {
    ...
    stats: { power: 24, fireRate: 1.4, projectiles: 1, spread: 0, speed: 1.0, hp: 4, crit: 0.14, critDmg: 2.1, magnet: 1.3 },
  ...
  },
  {
    ...
    stats: { power: 20, fireRate: 2.2, projectiles: 2, spread: 0.3, speed: 1.06, hp: 4, crit: 0.18, critDmg: 2.2, magnet: 1.8 },
  ...
  },
  {
    ...
    stats: { power: 15, fireRate: 3.0, projectiles: 6, spread: 6.28, speed: 1.04, hp: 5, crit: 0.12, critDmg: 1.9, magnet: 1.5 },
...

  {
    ...
    stats: { power: 22, fireRate: 3.2, projectiles: 3, spread: 0.4, speed: 1.12, hp: 4, crit: 0.22, critDmg: 2.4, magnet: 1.6 },
  ...
  },
  {
    ...
    stats: { power: 18, fireRate: 5.5, projectiles: 4, spread: 0.2, speed: 1.15, hp: 4, crit: 0.2, critDmg: 2.3, magnet: 1.7 },
